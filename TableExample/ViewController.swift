...
//  TableExample
//
//  Created by jbarrull on 31/05/2022.
//
...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        print("You selected section \(indexPath.section) and row \(indexPath.row)")
    }
    // Create task arrays
    var dailyTasks = [
        ...
        Task(name: "Check the mailbox", type: .daily, completed: true, lastCompleted: nil),
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = "Some detailed text"
